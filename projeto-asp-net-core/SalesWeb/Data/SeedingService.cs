...
namespace SalesWeb.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesWebContext database)
        {
        ...
        public void Seed() 
        {
            if(Database.Department.Any() || Database.Seller.Any() || Database.SalesRecord.Any())
                return;
            ...
            Database.Department.AddRange(d1, d2, d3, d4);

            Database.Seller.AddRange(s1, s2, s3, s4, s5, s6);

            Database.SalesRecord.AddRange(
